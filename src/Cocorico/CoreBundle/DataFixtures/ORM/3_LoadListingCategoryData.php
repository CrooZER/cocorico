...
class LoadListingCategoryData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $category->translate('nl')->setName('Categorie1');
        ...
        $subCategory1->translate('nl')->setName('Categorie1_1');
        ...
        $subCategory2->translate('nl')->setName('Categorie1_2');
        ...
        $subSubCategory1->translate('nl')->setName('Categorie2_1_1');
        ...
        $subCategory2->translate('nl')->setName('Categorie2_2');
        $subCategory2->setParent($category);
