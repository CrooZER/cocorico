...
class LoadListingCharacteristicValueData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $listingCharacteristicValue->translate('nl')->setName('Ja');
        ...
        $listingCharacteristicValue->translate('nl')->setName('Nee');
        ...
        $listingCharacteristicValue->translate('nl')->setName('1');
        $listingCharacteristicValue->setPosition(1);
        ...
        $listingCharacteristicValue->translate('nl')->setName('2');
        $listingCharacteristicValue->setPosition(2);
        $listingCharacteristicValue->setListingCharacteristicType($listingCharacteristicType);
        $manager->persist($listingCharacteristicValue);
        $listingCharacteristicValue->mergeNewTranslations();
        ...
        $listingCharacteristicValue->translate('nl')->setName('3');
        ...
        $listingCharacteristicValue->translate('nl')->setName('Aangepaste Waarde 1');
        $listingCharacteristicValue->setPosition(1);
        ...
        $listingCharacteristicValue->translate('nl')->setName('Aangepaste Waarde 2');
        $listingCharacteristicValue->setPosition(2);
        $listingCharacteristicValue->setListingCharacteristicType($listingCharacteristicType);
        $manager->persist($listingCharacteristicValue);
        $listingCharacteristicValue->mergeNewTranslations();
