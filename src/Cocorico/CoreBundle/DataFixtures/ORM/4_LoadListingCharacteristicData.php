...
class LoadListingCharacteristicData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $listingCharacteristic->translate('nl')->setName('Karakteristiek_1');
        ...
        $listingCharacteristic->translate('nl')->setDescription('Kenmerkende beschrijving_1');
        ...
        $listingCharacteristic->translate('nl')->setName('Karakteristiek_2');
        ...
        $listingCharacteristic->translate('nl')->setDescription('Beschrijving van het kenmerk_2');
        ...
        $listingCharacteristic->translate('nl')->setName('Karakteristiek_3');
        ...
        $listingCharacteristic->translate('nl')->setDescription('Beschrijving van het kenmerk_3');
        ...
        $listingCharacteristic->translate('nl')->setName('Karakteristiek_4');
        ...
        $listingCharacteristic->translate('nl')->setDescription('Beschrijving van het kenmerk_4');
        $listingCharacteristicType = $manager->merge($this->getReference('characteristic_type_custom_1'));
        $listingCharacteristic->setListingCharacteristicType($listingCharacteristicType);
        $listingCharacteristicGroup = $manager->merge($this->getReference('group_2'));
        $listingCharacteristic->setListingCharacteristicGroup($listingCharacteristicGroup);
